...
namespace QD256Numeric
{
		...
		IMinMaxValue<QD256>, IRootFunctions<QD256>, ITrigonometricFunctions<QD256>, IHyperbolicFunctions<QD256>, IFloatingPointConstants<QD256>
	{
...
#if UseDD128
		public static QD256 operator +(in QD256 left, in DD128 right)
		  {
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator +(in DD128 left, in QD256 right) => right + left;
#endif
		public static QD256 operator +(in QD256 left, double right)
		  {
				double c0, c1, c2, c3;
				double e;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator +(double left, in QD256 right) => right + left;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 Add(double left, double right) => new QD256(left) + right;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Add(in QD256 other) => this + other;

#if UseDD128
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Add(in DD128 other) => this + other;
#endif
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Add(double other) => this + other;

		  public QD256 AddSloppy(in QD256 other)
		  {
				double s0, s1, s2, s3;
				double t0, t1, t2, t3;
...
#if UseDD128
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator -(in QD256 left, in DD128 right) => left + -right;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator -(in DD128 left, in QD256 right) => left + -right;
#endif
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator -(in QD256 left, double right) => left + -right;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator -(double left, in QD256 right) => left + -right;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 Subtract(double left, double right) => new QD256(left) - right;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Subtract(in QD256 other) => this - other;

#if UseDD128
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Subtract(in DD128 other) => this - other;
#endif
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Subtract(double other) => this - other;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 SubtractSloppy(in QD256 other) => AddSloppy(-other);
		...
		public static QD256 operator *(in QD256 left, double right)
		  ...
		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Multiply(in QD256 other) => this * other;

#if UseDD128
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Multiply(in DD128 other) => this * other;
#endif
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Multiply(double other) => this * other;

		  public QD256 MultiplySloppy(in QD256 other)
		  {
				double p0, p1, p2, p3, p4, p5;
				double q0, q1, q2, q3, q4, q5;
				double t0, t1;
...
#if UseDD128
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator /(in QD256 left, in DD128 right) => left / (QD256) right;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator /(in DD128 left, in QD256 right) => (QD256) left / right;
#endif
#if UseDD128
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator /(in QD256 left, double right)
...
#endif
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 operator /(double left, in QD256 right) => (QD256) left / right;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public static QD256 Divide(double left, double right) => new QD256(left) / right;

		  [MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Divide(in QD256 other) => this / other;

#if UseDD128
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Divide(in DD128 other) => this / other;
#endif
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		  public QD256 Divide(double other) => this / other;

		  public QD256 DivideSloppy(in QD256 other)
		  {
				double q0, q1, q2, q3;
...
#pragma warning restore CS1718
		...
		public static bool IsNegative(QD256 d) => BitConverter.DoubleToInt64Bits(d.x0) < 0 && BitConverter.DoubleToInt64Bits(d.x1) < 0;//redo ?!
		public static bool IsPositive(QD256 value) => BitConverter.DoubleToInt64Bits(value.x0) >= 0 && BitConverter.DoubleToInt64Bits(value.x1) >= 0;//redo ?!
