...
#pragma warning restore CS1718
		...
		public static bool IsNegative(DD128 d) => BitConverter.DoubleToInt64Bits(d.High) < 0 && BitConverter.DoubleToInt64Bits(d.Low) < 0;
		public static bool IsPositive(DD128 value) => BitConverter.DoubleToInt64Bits(value.High) >= 0 && BitConverter.DoubleToInt64Bits(value.Low) >= 0;
